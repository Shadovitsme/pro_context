#Set variables here
LARAVEL_OWNER=ukki # <-- owner (user)
LARAVEL_WS_GROUP=www-data # <-- WebServer group
LARAVEL_ROOT=/home/ukki/Documents/internetlaboratory/ # <-- Laravel root directory
...
sudo find ${LARAVEL_ROOT} -type f -exec chmod 777 {} \;

# Set correct permissions for files 
sudo find ${LARAVEL_ROOT} -type d -exec chmod 777 {} \;
